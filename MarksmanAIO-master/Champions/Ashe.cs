    ...
    class Ashe : AIOChampion
    {
        ...
        public override void Init()
        {
            ...
            try
            {
                ...
                _e = new Spell.Skillshot(SpellSlot.E, 3000, SkillShotType.Linear, 250, 1400, 300);
                ...
                MainMenu.HarassManaManager(true, true, false, false, 60, 80, 0, 0);
                ...
                MainMenu._misc.AddGroupLabel("Auto E - Auto W Settings", "misc.grouplabel1.addonmenu", true);
        ...
        public override void Combo()
        {
            ...
            if (Value.Use("combo.r") && _r.IsReady() && Value.Use("combo.r.aoe"))
            {
                if (targetr != null &&
                    targetr.CountEnemiesInRange(200) >= Value.Get("combo.r.slider"))
                {
        ...
        {
            foreach (var enemy in EntityManager.Heroes.Enemies.Where(a => a.IsValidTarget(2000)))
            {
                if (enemy != null)
                {
                    ...
                    if (flags.HasFlag(CollisionFlags.Grass))
                    {
                                ...
                                a => a.IsValidTarget(2000) && !a.IsDead && !a.IsZombie && a.HealthPercent <= 30))
                {
                    ...
                    if (Value.Use("killsteal.r") && _r.IsReady() && Player.Instance.ManaPercent >= Value.Get("killsteal.r.mana"))
                    {
                        if (_r.IsInRange(enemy) &&
                            ...
                            enemy.Distance(Player.Instance.Position) > 1000 && enemy.CountAlliesInRange(600) == 0)
                        {
